  ...
  <table className="min-w-full bg-white">
    <thead>
      <tr> 
        ...
        <th className="py-2 px-4 text-black-700 border-b"> Process</th>
        <th className="py-2 px-4 text-black-700 border-b">Trigger Details</th>
        <th className="py-2 px-4 text-black-700 border-b">Next Run Time</th>
        <th className="py-2 px-4 text-black-700 border-b">State</th>
        <th className="py-2 px-4 text-black-700 border-b">Error</th>
        <th >
